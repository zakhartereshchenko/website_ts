        ...
        <>
            <section className={styles.hero}>
                <div className={styles.textInfo}>
                    <h1 className={styles.title}>Hi, I'm <span className={styles.color}>Zakhar</span></h1>
                    <h3 className={styles.subtitle}>Front End Developer from Warsaw</h3>
                </div>
            ...
            <MoveDown className={styles.moveDown} />
        </>
    )
}
